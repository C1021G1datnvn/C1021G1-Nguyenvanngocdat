...
<body>
<h1 style="text-align: center; color: paleturquoise">Create Product</h1>
        ...
        <div class="col-9">
            <form action="/product?action=create" method="post" >
                <div class="form-group invalid">
                    ...
                    <input type="text" class="form-control" id="name-customer" name="name" required placeholder="VD:DdatjPro">
