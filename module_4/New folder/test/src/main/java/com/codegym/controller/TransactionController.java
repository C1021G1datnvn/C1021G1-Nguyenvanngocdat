...
public class TransactionController {
    ...
    @GetMapping("/search")
    public ModelAndView searchCustomer(@RequestParam(name = "name", required = false) String name, Model model, @PageableDefault(value = 5, sort = "customerName", direction = Sort.Direction.ASC) Pageable pageable) {
        ...
        ModelAndView modelAndView = new ModelAndView("list", "transactionList",transactionPage);
        return modelAndView;
    }
}
